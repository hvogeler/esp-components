...
#define LCD_BK_LIGHT_LEDC_CH CONFIG_HV_TDISPLAYS3_LCD_BK_LIGHT_LEDC_CH
...
#define LCD_PIXEL_CLOCK_HZ (CONFIG_HV_TDISPLAYS3_LCD_PIXEL_CLOCK_MHZ * 1000 * 1000)

#define LCD_I80_TRANS_QUEUE_SIZE CONFIG_HV_TDISPLAYS3_LCD_I80_TRANS_QUEUE_SIZE
...
#define LVGL_TICK_PERIOD_MS CONFIG_HV_TDISPLAYS3_LVGL_TICK_PERIOD_MS
#define LVGL_MAX_SLEEP_MS CONFIG_HV_TDISPLAYS3_LVGL_MAX_SLEEP_MS
#define LVGL_TASK_STACK_SIZE CONFIG_HV_TDISPLAYS3_LVGL_TASK_STACK_SIZE
#define LVGL_TASK_PRIORITY CONFIG_HV_TDISPLAYS3_LVGL_TASK_PRIORITY
